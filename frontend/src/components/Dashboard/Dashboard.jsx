    ...
    <div className="container mx-auto mt-10 bg-black">
      ...
      <div className="border-2 rounded-2xl p-10 mt-5 dark:text-white">
        <div className="flex justify-around">
          <div className="flex flex-col">
            <p className="text-2xl text-white">{`$${getInvestedValue().toFixed(2)}`}</p>
            <p className="text-white">Invested Value</p>
          </div>
          <div className="flex flex-col">
        ...
        <div>
          {/* Table for stock holdings */}
          {stockHoldings.length === 0 ? (
            <p className="text-center text-white">No stocks in your portfolio</p>
          ) : (
            <table className="min-w-full table-auto">
              <thead>
                <tr className="text-left">
